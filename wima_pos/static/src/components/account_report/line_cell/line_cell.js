...
import { AccountReportCarryoverPopover } from "@wima_pos/components/account_report/line_cell/popover/carryover_popover";
import { AccountReportEditPopover } from "@wima_pos/components/account_report/line_cell/popover/edit_popover";

import { Component, markup, useState } from "@odoo/owl";

export class AccountReportLineCell extends Component {
    static template = "wima_pos.AccountReportLineCell";
    static props = {
        line: {
            type: Object,
            optional: true,
