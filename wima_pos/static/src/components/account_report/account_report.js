...
import { AccountReportController } from "@wima_pos/components/account_report/controller";
import { AccountReportButtonsBar } from "@wima_pos/components/account_report/buttons_bar/buttons_bar";
import { AccountReportEllipsis } from "@wima_pos/components/account_report/ellipsis/ellipsis";
import { AccountReportFilters } from "@wima_pos/components/account_report/filters/filters";
import { AccountReportHeader } from "@wima_pos/components/account_report/header/header";
import { AccountReportLine } from "@wima_pos/components/account_report/line/line";
import { AccountReportLineCell } from "@wima_pos/components/account_report/line_cell/line_cell";
import { AccountReportLineName } from "@wima_pos/components/account_report/line_name/line_name";
import { AccountReportSearchBar } from "@wima_pos/components/account_report/search_bar/search_bar";

export class AccountReport extends Component {
    static template = "wima_pos.AccountReport";
    static props = {
        action: Object,
    ...
    getTemplate(name) {
        ...
        return `wima_pos.${ name }Customizable`;
    }
