...
import { AccountReportEllipsisPopover } from "@wima_pos/components/account_report/ellipsis/popover/ellipsis_popover";

export class AccountReportEllipsis extends Component {
    static template = "wima_pos.AccountReportEllipsis";
    static props = {
