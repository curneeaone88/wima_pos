...
import { ExpectedDateDialog } from "@wima_pos/components/aged_partner_balance/dialog/expected_date_dialog";
...
export class AgedPartnerBalanceLineName extends AccountReportLineName {
    static template = "wima_pos.AgedPartnerBalanceLineName";
