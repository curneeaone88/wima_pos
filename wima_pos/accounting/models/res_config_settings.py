...
class ResConfigSettings(models.TransientModel):
    ...
    group_fiscal_year = fields.Boolean(string='Fiscal Years', implied_group='wima_pos.group_fiscal_year')
    ...
    revenue_realization_journal_id = fields.Many2one(
        comodel_name='account.journal',
        string='Realization Entries Journal',
        help='Journal used for revenue realization entries',
        readonly=False,
        related='company_id.revenue_realization_journal_id',
    )

    reverse_entry_journal_id = fields.Many2one(
        comodel_name='account.journal',
        string='Reverse Entries Journal',
        help='Journal used for reverse entries',
        readonly=False,
        related='company_id.reverse_entry_journal_id',
    )
