...
class AccountBankStatementLine(models.Model):
    ...
    def action_save_new(self):
        action = self.env['ir.actions.act_window']._for_xml_id('wima_pos.action_bank_statement_line_form_bank_rec_widget')
    ...
    def _action_open_bank_reconciliation_widget(self, extra_domain=None, default_context=None, name=None, kanban_first=True):
        ...
        views = [
            (self.env.ref('wima_pos.view_bank_statement_line_kanban_bank_rec_widget').id, 'kanban'),
            (self.env.ref('wima_pos.view_bank_statement_line_tree_bank_rec_widget').id, 'list'),
        ]
        ...
        return {
            ...
            'context': context,
            'search_view_id': [self.env.ref('wima_pos.view_bank_statement_line_search_bank_rec_widget').id, 'search'],
