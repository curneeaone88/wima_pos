...
class account_journal(models.Model):
    ...
    balancing_account_id = fields.Many2one('account.account', string='Balancing Account', check_company=True, default=False)
    ...
    def action_open_reconcile(self):
        ...
        if self.type in ('bank', 'cash'):
            ...
            return self.env['ir.actions.act_window']._for_xml_id('wima_pos.action_move_line_posted_unreconciled')
