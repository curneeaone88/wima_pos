...
class AccountFollowupReport(models.AbstractModel):
    ...
    def get_followup_report_html(self, options):
        ...
        """
        template = 'wima_pos.template_followup_report'
        ...
        for currency, aml_recs in res.items():
            ...
            for aml in aml_recs:
                ...
                invoice_date = {
                    ...
                    'template': 'wima_pos.cell_template_followup_report',
                }
                ...
                lines.append({
                    ...
                    'unfoldable': False,
                    'columns': [isinstance(v, dict) and v or {'name': v, 'template': 'wima_pos.cell_template_followup_report'} for v in columns],
                })
            ...
            lines.append({
                ...
                'unfoldable': False,
                'level': 0,
                'columns': [{'template': 'wima_pos.cell_template_followup_report'} for col in columns],
            })
...
""", partner.name)
    ...
    def _print_followup_letter(self, partner, options=None):
        ...
        """
        action = self.env.ref('wima_pos.action_report_followup')
        ...
        followup_letter = action.with_context(lang=partner.lang or self.env.user.lang)._render_qweb_pdf('wima_pos.report_followup_print_all', partner.id, data={'options': options or {}})[0]
